        ...
        <div className='my-10'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 mx-10 gap-10'>
                <div className='mt-6 text-center pr-2 border-r-2'>
                    <div><FaShippingFast className='w-20 h-20 mx-auto text-rose-500 border-2 p-3 border-rose-500 rounded-full'></FaShippingFast></div>
                    <h4 className='text-xl font-bold '>Free Shipping</h4>
                    <p>With our FREE shipping offer, you can conveniently browse and order your favorite toys from the comfort of your own home. We will ensure your purchase is carefully packaged and delivered right to your doorstep, saving you time and effort.</p>
                </div>
                
                <div className='mt-6 text-center  pr-2 border-r-2'>
                    <div><GiReturnArrow className='w-20 h-20 mx-auto text-rose-500 border-2 p-3 border-rose-500 rounded-full'></GiReturnArrow></div>
                    <h4 className='text-xl font-bold '>Gift Cards</h4>
                    <p>Struggling to find the perfect gift for a child in your life? Look no further than our Toy Store gift cards! With our gift cards, you can give the gift of endless possibilities, allowing the recipient to choose their own toy and create unforgettable memories.</p>
                    
                </div>
                
                
                <div className='mt-6 text-center  pr-2 border-r-2'>
                    <div><FaGifts className='w-20 h-20 mx-auto text-rose-500 border-2 p-3 border-rose-500 rounded-full'></FaGifts></div>
                    <h4 className='text-xl font-bold '>Free Shipping</h4>
                    <p>With our FREE shipping offer, you can conveniently browse and order your favorite toys from the comfort of your own home. We will ensure your purchase is carefully packaged and delivered right to your doorstep, saving you time and effort.</p>
