    ...
    return (
        ...
        <div className='bg-violet-100 flex justify-between items-center mt-0 p-5 rounded sm:max-w-xl md:max-w-full lg:w-full md:px-24 lg:px-8'>
            ...
            <Link to='/home' className='inline-flex items-center relative navbar-start'>
                ...
                <span className='title-text ml-2 text-2xl font-bold tracking-wide text-gray-800'>Disney Magic Toys</span>
            </Link>
...
{
   (<img  className='rounded-full w-[60px]' alt="" />
  )
}    
            ...
            <div className='absolute top-0 left-0 w-full z-10'>
              <div className='p-5 bg-white border rounded shadow-sm'>
                ...
                <nav>
                  ...
                  <span><img  className='rounded-full w-1/2' alt="" /></span>
